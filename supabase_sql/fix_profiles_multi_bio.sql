...
-- Recreate profiles table with UUID id as primary key
...
-- Function to get user's subscription plan from pro_status
...
-- Function to check if user can create a profile based on their plan
...
-- Create one primary profile on user signup
